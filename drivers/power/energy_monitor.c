...
static struct energy_mon_mapping_table_t energy_mon_table[] = {
	...
	{649, ENERGY_MON_WAKEUP_INPUT},
	{650, ENERGY_MON_WAKEUP_INPUT},
	{651, ENERGY_MON_WAKEUP_INPUT},
	{648, ENERGY_MON_WAKEUP_INPUT},
	{290, ENERGY_MON_WAKEUP_INPUT},
	{810, ENERGY_MON_WAKEUP_INPUT},

	/* ENERGY_MON_WAKEUP_SSP */
	{645, ENERGY_MON_WAKEUP_SSP},

	/* ENERGY_MON_WAKEUP_RTC */
	{334, ENERGY_MON_WAKEUP_RTC},

	/* ENERGY_MON_WAKEUP_BT */
	{642, ENERGY_MON_WAKEUP_BT},

	/* ENERGY_MON_WAKEUP_WIFI */
	{647, ENERGY_MON_WAKEUP_WIFI},
...
static ssize_t energy_monitor_print_time_logs(char *buf, int sizeof_buf, int type)
{
	...
	if (need_to_show_average) {
		...
		snprintf(temp_buf, sizeof(temp_buf), "/%4d/%5lu/%5lu/%5lu/%3ld.%02ldmA/%3ld.%02ld/%3ld.%02ld/%3d/%3d/%3d/%3d/%3d/%3d\n"
			, diff_soc
			, diff_boot
			, diff_kern
			, diff_disp
	...
	ret += snprintf(buf + ret, sizeof_buf, "%c/%03d/%d/%d/%5d/%04d/%10lu.%03lu/%04d-%02d-%02d %02d:%02d:%02d/%6lu.%03lu/%6lu.%03lu/%6lu.%03lu%s"
	...
	char __user *buffer, size_t count, loff_t *ppos)
{
	...
	if (*ppos == 0) {
		...
		ret += snprintf(buf + ret, sizeof(buf),
			"T/CNT/S/B/CAPA_/SUSP/REAL_TIME_UTC_/REAL_TIME_RTC_(UTC)/BOOT_TIME_/KERN_TIME_/DISP_TIME_/dSOC/dBOOT/dKERN/dDISP/CUR_AVER/KERN_%%/DISP_%%/INP/SSP/RTC/BT_/WIF/CP_\n");
...
#ifdef CONFIG_ENERGY_MONITOR_WAKEUP_STAT
int energy_monitor_wakeup_stat(unsigned long event)
{
...
#endif
#ifdef CONFIG_ENERGY_MONITOR_WAKEUP_STAT
	energy_monitor_wakeup_stat(event);
#endif
	return NOTIFY_DONE;
}
