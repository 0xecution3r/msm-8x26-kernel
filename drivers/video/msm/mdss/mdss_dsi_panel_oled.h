...
#elif defined(CONFIG_SMART_DIMMING_S6E36W1X01)
 #include <linux/smart_dimming_s6e36w1x01.h>
#endif
#ifdef CONFIG_FB_MSM_MDSS_SDC_S6E36W1X01_PANEL
#define GAMMA_CMD_CNT		37
#define LDI_MTP_SET			0xCA
#define MIN_ACL				0
#define MAX_ACL				3
#define MAX_MTP_CNT		32
#define LDI_ID_LEN			3
#else
...
struct mdss_samsung_driver_data {
	...
	unsigned char ldi_code[LDI_CODE_LEN];
	...
	struct dsi_panel_cmds scm_on_cmds;
	struct dsi_panel_cmds scm_off_cmds;
	...
	struct dsi_panel_cmds ldi_code_cmd;
	...
	struct dsi_panel_cmds gray_tune_cmd;
	struct dsi_panel_cmds neg_tune_cmd;
	struct dsi_panel_cmds outdoor_tune_cmd;
	struct dsi_panel_cmds curtain_tune_cmd;
	struct dsi_panel_cmds gray_negative_cmd;
	struct dsi_panel_cmds mcd_on_cmd;
	struct dsi_panel_cmds mcd_off_cmd;
	struct dsi_panel_cmds ltps_def_cmd;
#if defined(CONFIG_SMART_DIMMING_S6E36W0X01)\
	|| defined(CONFIG_SMART_DIMMING_S6E36W1X01)
