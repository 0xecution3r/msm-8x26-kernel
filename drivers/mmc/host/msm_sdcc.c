...
#if defined(CONFIG_BCM4335) || defined(CONFIG_BCM4335_MODULE) || defined(CONFIG_BCM4339) || defined(CONFIG_BCM4339_MODULE) || defined(CONFIG_BCM4354) || defined(CONFIG_BCM4354_MODULE) || defined(CONFIG_BCM4334) || defined(CONFIG_BCM4343)
...
#if defined(CONFIG_BCM4335) || defined(CONFIG_BCM4335_MODULE) || defined(CONFIG_BCM4339) || defined(CONFIG_BCM4339_MODULE) || defined(CONFIG_BCM4354) || defined(CONFIG_BCM4354_MODULE) || defined(CONFIG_BCM4334) || defined(CONFIG_BCM4343)
	printk(KERN_ERR"%s: before parsing vendor_type\n", __func__);
	if (of_get_property(np, "status-cb", &vendor_type)) {
		printk(KERN_ERR"%s: vendor_type=%d \n", __func__, vendor_type);
		//if(1 == vendor_type) {
