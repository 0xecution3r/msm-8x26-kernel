 ...
 *
 * The original QC quide value is 2000(2sec), but there is a locked up issue
 * when GPU tries to render heavy jobs.
 * So delays timeout as this work around value 6000(6sec) which is agreed by QC.
 */
static unsigned int _cmdbatch_timeout = 6000;
