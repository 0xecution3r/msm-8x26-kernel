...
exit:
	ssp_dbg("[SSP]: %s Result\n"
		...
		"[SSP]: hrm_raw %d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n"
		"[SSP]: hrm_lib %d,%d,%d\n"
#endif
...
#ifdef CONFIG_SENSORS_SSP_LPS25H
		, fsb[PRESSURE_SENSOR].pressure[0], fsb[PRESSURE_SENSOR].pressure[1]
#endif
#ifdef CONFIG_SENSORS_SSP_AL3320
		, fsb[LIGHT_SENSOR].raw_high, fsb[LIGHT_SENSOR].raw_low
#endif
#ifdef CONFIG_SENSORS_SSP_ADPD142
	...
	count = sprintf(buf, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%u,"
		"%u,	%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%u\n",
		fsb[ACCELEROMETER_SENSOR].x, fsb[ACCELEROMETER_SENSOR].y,
		fsb[ACCELEROMETER_SENSOR].z, fsb[GYROSCOPE_SENSOR].x,
		fsb[GYROSCOPE_SENSOR].y, fsb[GYROSCOPE_SENSOR].z,
		fsb[GEOMAGNETIC_SENSOR].cal_x, fsb[GEOMAGNETIC_SENSOR].cal_y,
