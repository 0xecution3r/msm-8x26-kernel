...
#define SSP_FIRMWARE_REVISION_03_STM	14081200
#define SSP_FIRMWARE_REVISION_STM	14102300

#define BOOT_SPI_HZ		4800000
#define NORM_SPI_HZ	4800000
#else
#define SSP_FIRMWARE_REVISION_STM	14052601
...
/* Bootload mode cmd */
#if 0/* fw name is moved to dt file */
#define BL_FW_REV02_NAME			"ssp_B2_Rev02.fw"
#define BL_UMS_REV02_FW_NAME		"ssp_B2_Rev02.bin"
#endif
#define BL_FW_NAME					"ssp_stm.fw"
#define BL_UMS_FW_NAME			"ssp_stm.bin"
#define BL_CRASHED_FW_NAME		"ssp_crashed_stm.fw"
...
unsigned int get_module_rev(struct ssp_data *data)
{
	...
	if (data->ap_rev > 7)
		...
		return SSP_FIRMWARE_REVISION_03_STM;
#else
	return SSP_FIRMWARE_REVISION_STM;
#endif
}
...
int check_fwbl(struct ssp_data *data)
{
	...
	if (data->ap_rev > 7)
		...
		fw_revision = SSP_FIRMWARE_REVISION_03_STM;
#else
	fw_revision = SSP_FIRMWARE_REVISION_STM;
#endif
