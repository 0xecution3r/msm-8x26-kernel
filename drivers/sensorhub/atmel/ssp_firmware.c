...
#define SSP_FIRMWARE_REVISION_FINAL		16061300


#if defined (CONFIG_MACH_WJ1)
#define BL_FW_NAME			"ssp_wj1.fw"
#else
#define BL_FW_NAME			"ssp_wc1-l.fw"
#endif
...
static int update_mcu_bin(struct ssp_data *data, int iBinType)
{
	...
	case UMS_BINARY:
		if (data->ums_fw_name)
			iRet = load_ums_fw_bootmode(data, data->ums_fw_name);
		else
