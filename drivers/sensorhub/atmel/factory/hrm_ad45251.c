	...
	struct device_attribute *attr, char *buf)
{
	...
	memcpy(data->hrmcal, data->buf[BIO_HRM_RAW_FAC].hrm_eol_data, sizeof(data->hrmcal));

	save_hrm_eol_data(data);
	set_hrm_calibration(data);

	return sprintf(buf, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[0],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[1],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[2],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[3],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[4],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[5],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[6],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[7],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[8],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[9],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[10],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[11],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[12],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[13],
			data->buf[BIO_HRM_RAW_FAC].hrm_eol_data[14]);
}
