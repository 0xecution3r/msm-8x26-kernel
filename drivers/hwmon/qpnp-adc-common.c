...
/* Voltage to temperature for PAM Thermistor */
static const struct qpnp_vadc_map_pt adcmap_pam_100k[] = {
	{1820,  -35},
	{1802,  -30},
	{1778,  -25},
	{1749,  -20},
...
static const struct qpnp_vadc_map_pt adcmap_pam_68k[] = {
	{1760,  -40},
	{1752,  -35},
	{1739,  -30},
	{1717,  -25},
...
int32_t qpnp_adc_scale_pam_therm(struct qpnp_vadc_chip *chip,
		int32_t adc_code,
		const struct qpnp_adc_properties *adc_properties,
		const struct qpnp_vadc_chan_properties *chan_properties,
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	qpnp_adc_map_voltage_temp(adcmap_pam_68k,
		ARRAY_SIZE(adcmap_pam_68k),
		therm_voltage, &adc_chan_result->physical);
#else
	qpnp_adc_map_voltage_temp(adcmap_pam_100k,
		ARRAY_SIZE(adcmap_pam_100k),
		therm_voltage, &adc_chan_result->physical);
#endif

	return 0;
}
EXPORT_SYMBOL(qpnp_adc_scale_pam_therm);
