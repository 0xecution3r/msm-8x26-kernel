...
/* 
 * these 2 below enums are kept back from enum core_id while merging 
 * camera code from Andorid Millet CL_946918 to support encoder 
 */
#define MSM_VIDC_CORE_VENUS 0
#define MSM_VIDC_CORE_Q6 1
