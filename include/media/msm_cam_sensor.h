...
struct msm_actuator_calib_info_t {
	uint16_t infinity_data;
	uint16_t macro_data;
	uint16_t adc_min_data;
	uint16_t adc_max_data;
};
...
struct msm_actuator_cfg_data {
	...
	struct msm_actuator_calib_info_t calib_info;
};
