...
#define DC_MOTOR_VOL_MAX 27
#define DC_MOTOR_VOL_MIN 15
...
extern void vib_enable(bool en);
extern void vib_set_voltage(int val);
extern void set_temp_gpio_set(bool is_temp_on);
#endif
