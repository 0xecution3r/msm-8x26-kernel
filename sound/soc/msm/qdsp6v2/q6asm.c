...
int q6asm_send_mtmx_strtr_window_start(struct audio_client *ac,
				       struct asm_stream_mtmx_strtr_param_window_v2_t *window_param)
{
	...
	matrix.data.param_id = ASM_SESSION_MTMX_STRTR_PARAM_RENDER_WINDOW_START_V2;
...
int q6asm_send_mtmx_strtr_window_end(struct audio_client *ac,
		struct asm_stream_mtmx_strtr_param_window_v2_t *window_param)
{
	struct asm_mtmx_strtr_params matrix;
	int sz = 0;
	...
	matrix.param.direction = 0; /* RX */
	matrix.data.module_id = ASM_SESSION_MTMX_STRTR_MODULE_ID_AVSYNC;
	matrix.data.param_id = ASM_SESSION_MTMX_STRTR_PARAM_RENDER_WINDOW_END_V2;
	matrix.data.param_size = matrix.param.data_payload_size -
		sizeof(matrix.data);
	matrix.data.reserved = 0;
	matrix.window_lsw = window_param->window_lsw;
