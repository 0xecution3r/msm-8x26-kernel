...
enum {
        FE_DAI_MAP_MULTIMEDIA1 = 0,
        FE_DAI_MAP_MULTIMEDIA2,
        FE_DAI_MAP_MULTIMEDIA3,
        FE_DAI_MAP_MULTIMEDIA4,
        FE_DAI_MAP_MULTIMEDIA5,
        FE_DAI_MAP_MULTIMEDIA6,
        FE_DAI_MAP_MULTIMEDIA7,
        FE_DAI_MAP_MULTIMEDIA8,
};
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	mutex_lock(&routing_lock);
	ac = q6asm_get_audio_client(fe_dai_map[FE_DAI_MAP_MULTIMEDIA3][SESSION_TYPE_RX].strm_id);
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{"INTERNAL_BT_SCO_RX Audio Mixer", "MultiMedia10", "MM_UL10"},
