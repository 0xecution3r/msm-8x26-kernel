...
#define DBMD2_VA_SENS_RECOGNITION_MODE			0x80400000
#define DBMD2_VA_SENS_TG_THRESHOLD			0x80470000
#define DBMD2_VA_SENS_VERIF_THRESHOLD			0x80480000
#define DBMD2_VA_SENS_WORDID				0x805B0000
#define DBMD2_VA_SENS_ALTWORDID				0x805C0000
