...
/* MSM8974 WLAN_EN GPIO Number */
	...
	|| defined(CONFIG_MACH_KS01SKT) || defined(CONFIG_TIZEN_R_PROJECT)\
	|| defined(CONFIG_MACH_B3) || defined(CONFIG_MACH_WJ1)\
	|| defined(CONFIG_MACH_WC1) || defined(CONFIG_MACH_NC1)
...
static int brcm_wlan_power(int onoff)
{
	...
	|| defined(CONFIG_SEC_VIENNA_PROJECT) || defined(CONFIG_MACH_KS01SKT)\
	|| defined(CONFIG_TIZEN_R_PROJECT) || defined(CONFIG_MACH_B3)\
	|| defined(CONFIG_MACH_WJ1) || defined(CONFIG_MACH_WC1)\
...
#if defined(CONFIG_BCM4339) || defined(CONFIG_BCM4335) || defined(CONFIG_BCM4354) || defined(CONFIG_BCM4334) || defined(CONFIG_BCM4343)
