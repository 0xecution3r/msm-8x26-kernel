...
static struct msm_gpiomux_config msm_earjack_configs[] __initdata = {
	{
		.gpio = 37,		/* EAR_SEND_END */
		.settings = {
...
#endif
#ifdef CONFIG_SAMSUNG_JACK
	msm_gpiomux_install(msm_earjack_configs, ARRAY_SIZE(msm_earjack_configs));
#endif
